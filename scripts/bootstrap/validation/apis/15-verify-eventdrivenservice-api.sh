...
<<<<<<<< HEAD:scripts/bootstrap/validation/06-apis/15-verify-eventdrivenservice-api.sh
...
>>>>>>>> ad3892423e89ac86668cd1958b206ef98d0386d4:scripts/bootstrap/validation/apis/15-verify-eventdrivenservice-api.sh
